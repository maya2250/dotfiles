...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (google-c-style smart-mode-line-powerline-theme smart-mode-line helm-rubygems-local helm-rubygems-org rubocop ruby-dev ruby-mode ruby-tools col-highlight indent-guide helm php-auto-yasnippets php-mode phpcbf clang-format ac-clang free-keys multiple-cursors neotree processing-mode processing-snippets markdown-mode emmet-mode python-mode tabbar undo-tree auto-complete init-loader))))
(custom-set-faces
